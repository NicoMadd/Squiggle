...
public class SelectQuery implements Outputable {
    ...
    public SelectQuery table(Table table) {
        this.baseTable = table;
        return this;
    }

    public SelectQuery table(String tableName, String alias) {
        this.baseTable = new Table(tableName, alias);
        return this;
    }

    public SelectQuery table(String tableName) {
    ...
    public SelectQuery select(Table table, String columname) {
        return SelectQuery.this.select(table.getColumn(columname));
    }
    ...
    public SelectQuery where(String columnName, Function<CriteriaBuilder, CriteriaBuilder> condition) {
        ...
        return condition.apply(criteriaBuilder).build().getClass() == NoCriteria.class ? this : this.addCriteria(condition.apply(criteriaBuilder).build());
    }
     ...
     *
     * @return List of {@link com.systech.Squiggle.Table}s
     */
