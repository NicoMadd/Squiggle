...
import com.squiggle.range.BigDecimalRange;
import com.squiggle.range.DateRange;
import com.squiggle.range.DoubleRange;
import com.squiggle.range.FloatRange;
import com.squiggle.range.IntegerRange;
import com.squiggle.range.StringRange;
...
public class BetweenCriteria extends Criteria {
   ...
   * 
   * @param column the first operand to the SQL BETWEEN operator that the operator
   *               uses to test whether the column falls within the given range.
   *               The SQL type of the column must be DECIMAL or NUMERIC.
   * 
   * @param range  the BigDecimal bounds for the SQL BETWEEN operator within which
   *               the operator tests whether the column lies.
   */
   ...
   * 
   * @param range  the Date bounds for the SQL BETWEEN operator within which the
   ...
   * 
   * @param range  the Double bounds for the SQL BETWEEN operator within which the
   *               operator tests whether the column lies.
   */
  ...
  /**
   * Initializes a new BetweenCriteria with a Float column and a Float range which
   * serves as the bounds for the SQL BETWEEN operator within which the operator
   * tests whether the column lies.
   * 
   * @param column the first operand to the SQL BETWEEN operator that the operator
   ...
   * 
   * @param range  the Float bounds for the SQL BETWEEN operator within which the
   *               operator tests whether the column lies.
   */
   ...
   * 
   * @param range  the Integer bounds for the SQL BETWEEN operator within which
   *               the operator tests whether the column lies.
   */
   ...
   * 
   * @param range  the String bounds for the SQL BETWEEN operator within which the
   *               operator tests whether the column lies.
   */
   ...
   * destination.
   * 
   * @param out the output destination to which we write the SQL BETWEEN operator.
   * 
